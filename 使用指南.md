...
2. 编辑 `config.py` 文件，填入你的真实配置：

```python
# GitLab配置
GITLAB_URL = "https://gitlab.com"  # 或你的私有GitLab
GITLAB_TOKEN = "glpat-your-token-here"

# AI模型配置 - 支持多种厂商
AI_PROVIDER = "siliconflow"  # 选择AI提供商: siliconflow, aliyun, openai等
...
### 1. 事件触发
当你在GitLab中创建Merge Request时，GitLab会发送webhook到我们的服务。
